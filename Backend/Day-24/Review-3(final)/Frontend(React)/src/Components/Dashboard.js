    ...
    <main className="main-container">
      ...
      <div className="main-cards">
        <div className="card">
          ...
          <strong><h3>ACTIVE USERS</h3></strong>
        ...
        <div className='charts'>
            ...
            >
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="pv" fill="#26577C" />
                <Bar dataKey="uv" fill="#E55604" />
                </BarChart>
            </ResponsiveContainer>
            ...
            <ResponsiveContainer width="100%" height="100%">
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="pv" stroke="#26577C" activeDot={{ r: 8 }} />
                <Line type="monotone" dataKey="uv" stroke="#E55604" />
                </LineChart>
            </ResponsiveContainer>
