  ...
  return (
    <div className="flex min-h-screen" style={bstyle}>
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-8" >
        ...
        <div>
        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900" style={{color:'balck'}}>
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link
                to={"/fpwd"}
                className="font-semibold balck-600 hover:text-indigo-500"
              >
                Forgot password?
              </Link>
            </div>
